#ifndef ELIX_CINEMATIC_EFFECTS_RENDER_GRAPH_PASS_HPP
#define ELIX_CINEMATIC_EFFECTS_RENDER_GRAPH_PASS_HPP
...
class CinematicEffectsRenderGraphPass : public IRenderGraphPass
{
public:
    explicit CinematicEffectsRenderGraphPass(std::vector<RGPResourceHandler> &inputHandlers);
...
#endif // ELIX_CINEMATIC_EFFECTS_RENDER_GRAPH_PASS_HPP
