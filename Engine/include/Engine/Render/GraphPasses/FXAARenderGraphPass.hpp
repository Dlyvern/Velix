#ifndef ELIX_FXAA_RENDER_GRAPH_PASS_HPP
#define ELIX_FXAA_RENDER_GRAPH_PASS_HPP
...
class FXAARenderGraphPass : public IRenderGraphPass
{
public:
    explicit FXAARenderGraphPass(std::vector<RGPResourceHandler> &inputHandlers);
...
#endif // ELIX_FXAA_RENDER_GRAPH_PASS_HPP
