...
public:
    ...
    static std::string ensureCustomMaterialShaderPath(const CPUMaterial &materialCPU);
...
private:
    ...
    std::unordered_map<std::string, std::filesystem::file_time_type> m_materialFileMtimes;
};
