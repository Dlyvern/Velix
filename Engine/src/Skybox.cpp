...
Skybox::Skybox(core::RenderPass::SharedPtr renderPass, const std::string &hdrPath, VkDescriptorPool descriptorPool)
{
    ...
    core::Shader shader("./resources/shaders/skybox.vert.spv", "./resources/shaders/skybox_hdr.frag.spv");
