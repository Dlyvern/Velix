...
int main(int argc, char** argv)
{
    ...
    testEntity->addComponent<elix::engine::LightComponent>(elix::engine::LightComponent::LightType::POINT);
    ...
    renderGraph.createCameraDescriptorSets();
    ...
    renderGraph.MAX_FRAMES_IN_FLIGHT, renderGraph.getGraphicsPipeline(), renderGraph.getPipelineLayout(), renderGraph.getCameraDescriptorSets(), renderGraph.getLightDescriptorSets());
    // renderGraph.addPass<elix::engine::OffscreenRenderGraphPass>(renderGraph.getPipelineLayout(), renderGraph.getCameraDescriptorSets(),
    // renderGraph.getViewportPipeline());
    ...
    dummyTexture->create(vulkanContext->getDevice(), renderGraph.getCommandPool(), vulkanContext->getGraphicsQueue());

    elix::engine::Material::createDefaultMaterial(vulkanContext->getDevice(), renderGraph.getDescriptorPool(),
...
//         const std::string path = "/home/dlyvern/Projects/Velix/resources/textures/texture.jpeg";
...
// 	{
// 		auto vertShaderCode = readFile("/home/dlyvern/Projects/Velix/resources/shaders/vert.spv");
// 		auto fragShaderCode = readFile("/home/dlyvern/Projects/Velix/resources/shaders/frag.spv");
...
// 					m_ViewportCommandBuffers[currentFrame],
// 					m_ImGuiCommandBuffers[currentFrame]
// 		};
