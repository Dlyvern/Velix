#include "Actions/PositionAction.hpp"

PositionAction::PositionAction(elix::GameObject *gameObject, const glm::vec3 &oldPosition, const glm::vec3 &newPosition) : m_gameObject(gameObject),
